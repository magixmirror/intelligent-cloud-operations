...
model_dump_filename = f"ad_nsrf_{current_date}.joblib"
joblib.dump(nsrf, model_dump_filename)
print(model_dump_filename)

scaler_dump_filename = f"ad_scaler_{current_date}.joblib"
...
fig.savefig(default_img_dest / "ad_roc-auc.eps", bbox_inches="tight")
...
thresh_df = roc_curve_df.loc[
    (roc_curve_df["fpr"] <= 0.1) & (roc_curve_df["tpr"] >= 0.85)
].tail(
    1
...
fig.savefig(default_img_dest / "ad_conf-mat.eps", bbox_inches="tight")
